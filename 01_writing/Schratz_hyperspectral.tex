...
\begin{figure} [t!]
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width = 1\textwidth] {predictions_demon_plots.pdf}}
...
\begin{figure} [t!]
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width = 0.6\textwidth] {predictions_demon_plots_hists.pdf}}
