...
\noindent An increase of the error rate was observed with an increases of descriptive plot measures such as mean point density and the coefficient of variation (based on the response \textit{defoliation}) (\autoref{fig:plot-characteristics}). 
...
\noindent Vegetation index \textit{GDVI} appears three times among the first seven most important features (\autoref{fig:var-imp}) with different .
