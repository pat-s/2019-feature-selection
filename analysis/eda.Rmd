...
```{r eda-3 }
vi_data_corrected_buffer2_no_defol = vi_data_corrected_buffer2
vi_data_corrected_buffer2_no_defol$defoliation <- NULL
pca <- DataExplorer::plot_prcomp(vi_data_corrected_buffer2_no_defol,
  variance_cap = 0.98,
...
```{r eda-5 }
# remove response
nri_data_corrected_buffer2$defoliation <- NULL
...
```{r eda-6 }
pca <- DataExplorer::plot_prcomp(nri_data_corrected_buffer2,
  variance_cap = 0.98,
  ggtheme = ggpubr::theme_pubclean()
)
pca[[1]]
...
```{r eda-8 }
# remove response
bands_data_corrected_buffer2$defoliation <- NULL
...
```{r eda-10 pca-bands, dev = c("png", "pdf")}
pca <- DataExplorer::plot_prcomp(bands_data_corrected_buffer2,
  variance_cap = 0.98,
  ggtheme = ggpubr::theme_pubclean()
)
pca[[1]]
