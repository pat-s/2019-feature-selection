...
```{r fi-hr-ale, dev = c("png", "pdf")}
fi_ale_hr_buffer2$plot(
  features = df_wavelengths_from_hr$class,
  ncol = 2
) & scale_y_continuous(
  breaks = c(0.0002, 0, -0.002),
  labels = c(0.0002, 0, -0.002)
) &
...
```{r fi-vi-ale, dev = c("png", "pdf")}
fi_ale_vi_buffer2$plot(
