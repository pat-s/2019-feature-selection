...
# load drake objects
drake::loadd(data_hs_preprocessed)
library("hsdar")
library("cowplot")
library("magrittr")
library("purrr")
...
# file_move(here("docs/figure/spectral-signatures.Rmd/spectral-signatures-1.pdf"),
#           here("code/98-paper/journal/"))
# file.copy(here("docs/figure/spectral-signatures.Rmd/spectral-signatures-1.pdf"),
#           here("code/98-paper/journal/"), overwrite = TRUE)
```
