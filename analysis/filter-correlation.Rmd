...
Spearman's rank correlation is used because we compare rankings against each other.

## VI

### Filter methods amongst each other

```{r correlation-filter-vi, warning=FALSE, dev = c("png", "pdf")}
...
```{r filter-correlation-3, warning=FALSE}
# combine filter values
...
file_move("docs/figure/filter-correlation.Rmd/correlation-filter-vi-1.pdf",
          "code/98-paper/journal/")
```
