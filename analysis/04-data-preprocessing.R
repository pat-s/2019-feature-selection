...
data_clean_single_plots = future_map(data_list_nri_vi_bands, ~ clean_single_plots(.x))

# extract coordinates of cleaned data Mon Mar 11 22:29:22 2019 ------------------------------

data_clean_single_plots_coords = future_map(data_list_nri_vi_bands, ~ extract_coords(.x))
...
data_trim_defoliation = future_map(list(data_vi_nri_clean, data_bands_clean), ~ mutate_defol(.x))
