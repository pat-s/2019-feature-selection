...
data_hs_raw <- download_hyperspectral("https://zenodo.org/record/2642139/files/hyperspectral.zip")

plot_locations <- download_locations("https://zenodo.org/record/2642139/files/plot-locations.gpkg")
