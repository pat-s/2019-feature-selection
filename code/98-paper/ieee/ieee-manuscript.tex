...
% filters
% - influence varies based on algorithm
% - no substantial improvement on these datasets compared to no filter
% - no substantial descrese in performance
...
% FIXME: add table of first 20(?) ordered performance results across all tasks
...
% - Effect varies across learnes -> suggest to use FS even on feature sets with p < 100?
