...
% simpler here.)
%\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{pschratz}}]{Patrick Schratz}
%\end{IEEEbiography}

\begin{IEEEbiography}
    [{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{pschratz}}]{Patrick Schratz}
Biography text here.
\end{IEEEbiography}

% or if you just want to reserve a space for a photo:

%\begin{IEEEbiography}{Patrick Schratz}
%Biography text here.
%\end{IEEEbiography}

% if you will not have a photo at all:
\begin{IEEEbiographynophoto}{Jannes Muenchow}
Biography text here.
...
\begin{IEEEbiographynophoto}{Alexander Brenning}
Biography text here.
\end{IEEEbiographynophoto}

\begin{IEEEbiographynophoto}{Bernd Bischl}
Biography text here.
\end{IEEEbiographynophoto}

\begin{IEEEbiographynophoto}{Eugenia Iturritxa}
Biography text here.
\end{IEEEbiographynophoto}
