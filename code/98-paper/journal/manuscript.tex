...
For the filter methods, the percentage of features was optimized as a hyperparameter.
The number of main components was tuned for the \ac{PCA} based benchmarking experiments.
