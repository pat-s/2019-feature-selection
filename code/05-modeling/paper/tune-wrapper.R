...
svm_borda <- makeTuneWrapper(filter_wrapper_svm_borda,
  resampling = inner,
...
svm_info.gain <- makeTuneWrapper(filter_wrapper_svm_info.gain,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_gain.ratio <- makeTuneWrapper(filter_wrapper_svm_gain.ratio,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_relief <- makeTuneWrapper(filter_wrapper_svm_relief,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_variance <- makeTuneWrapper(filter_wrapper_svm_variance,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_rank.cor <- makeTuneWrapper(filter_wrapper_svm_rank.cor,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_linear.cor <- makeTuneWrapper(filter_wrapper_svm_linear.cor,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_mrmr <- makeTuneWrapper(filter_wrapper_svm_mrmr,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_cmim <- makeTuneWrapper(filter_wrapper_svm_cmim,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_carscore <- makeTuneWrapper(filter_wrapper_svm_carscore,
  resampling = inner,
  par.set = ps_svm_filter,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_no_filter <- makeTuneWrapper(lrn_svm,
  resampling = inner,
  par.set = ps_svm,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
svm_pca <- makeTuneWrapper(pca_wrapper_svm,
  resampling = inner,
  par.set = ps_svm_pca,
  control = tune.ctrl_svm, show.info = TRUE,
  measures = list(rmse)
...
xgboost_relief <- makeTuneWrapper(filter_wrapper_xgboost_relief,
  resampling = inner,
  par.set = ps_xgboost_filter,
  control = tune.ctrl_xgboost, show.info = TRUE,
  measures = list(rmse)
...
xgboost_no_filter <- makeTuneWrapper(lrn_xgboost,
  resampling = inner,
  par.set = ps_xgboost,
  control = tune.ctrl_xgboost, show.info = TRUE,
  measures = list(rmse)
...
xgboost_pca <- makeTuneWrapper(pca_wrapper_xgboost,
  resampling = inner,
...
rf_borda <- makeTuneWrapper(filter_wrapper_rf_borda,
  resampling = inner,
...
rf_info.gain <- makeTuneWrapper(filter_wrapper_rf_info.gain,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_gain.ratio <- makeTuneWrapper(filter_wrapper_rf_gain.ratio,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_relief <- makeTuneWrapper(filter_wrapper_rf_relief,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_variance <- makeTuneWrapper(filter_wrapper_rf_variance,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_rank.cor <- makeTuneWrapper(filter_wrapper_rf_rank.cor,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_linear.cor <- makeTuneWrapper(filter_wrapper_rf_linear.cor,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_mrmr <- makeTuneWrapper(filter_wrapper_rf_mrmr,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_cmim <- makeTuneWrapper(filter_wrapper_rf_cmim,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_carscore <- makeTuneWrapper(filter_wrapper_rf_carscore,
  resampling = inner,
  par.set = ps_rf_filter,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_no_filter <- makeTuneWrapper(lrn_rf,
  resampling = inner,
  par.set = ps_rf,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
...
rf_pca <- makeTuneWrapper(pca_wrapper_rf,
  resampling = inner,
  par.set = ps_rf_pca,
  control = tune.ctrl_rf, show.info = TRUE,
  measures = list(rmse)
