...
filter_wrapper_lasso_info.gain <- makeFilterWrapper(lrn_lasso, fw.method = "FSelectorRcpp_information.gain", cache = TRUE, equal = TRUE)
...
filter_wrapper_ridge_info.gain <- makeFilterWrapper(lrn_ridge, fw.method = "FSelectorRcpp_information.gain", cache = TRUE, equal = TRUE)
...
filter_wrapper_lm_gain.ratio <- makeFilterWrapper(lrn_lm, fw.method = "FSelectorRcpp_gain.ratio", cache = TRUE, equal = TRUE)
filter_wrapper_lm_info.gain <- makeFilterWrapper(lrn_lm, fw.method = "FSelectorRcpp_information.gain", cache = TRUE, equal = TRUE)
