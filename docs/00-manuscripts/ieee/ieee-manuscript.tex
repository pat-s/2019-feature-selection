...
ALE plots were not discussed in greater detail and are available as supplementarty material.
...
Since filters are only calculated once due to caching, the runtime advantage might in fact be neglibile in practice.

\subsubsection{Linking feature importance to spectral characteristics}

Not surpringly the most important features for both HR and VI datasets were identified around the red egde of the spectra, specifically in the range of 700 nm to 750 nm.
