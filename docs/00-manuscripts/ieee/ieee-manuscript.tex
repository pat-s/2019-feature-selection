...
Random Forest hyperparameter \texttt{\(m_{try}\)} was modified into power transformed \(p^{m_{try}}\) (ranging from 1 to $p$) to work on relative values of the respective datasets feature count.
