...
However, there were also three settings (VI, NRI-VI, HR-NRI-VI) for which the RMSE of the ridge model was out of bounds.
That said, we cannot preclude possible mistakes on our side when optimizing the penalization terms of the penalized learners.
