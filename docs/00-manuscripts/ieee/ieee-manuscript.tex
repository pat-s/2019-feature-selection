...
Approaches for analyzing forest health include temporal change detection\cite{zhang2016} or describing the current health status of forests on a stand level\cite{townsend2012}.
...
Since both triggers and tree types are highly variable across regions, it cannot be known a-priori which indices are most important for describing the actual relationship.
