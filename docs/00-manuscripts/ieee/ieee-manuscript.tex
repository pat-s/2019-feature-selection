...
Even though the feature selection task was handed over to the filter methods in this study, we ensured to not include features with a pairwise correlation of 1.
