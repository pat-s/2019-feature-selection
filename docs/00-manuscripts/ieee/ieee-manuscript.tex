...
Performance differences between test folds were large: Predicting on Luiando resulted in an RMSE value of 9.0 for learner SVM (without filter) but up to 54.26 RMSE when testing on Laukiz2 (\autoref{tab:svm-single-fold-perf}).
