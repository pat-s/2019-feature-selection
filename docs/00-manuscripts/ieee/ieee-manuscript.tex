...
For SVM, all filters and 'no filter' achieved the same performance on tasks VI and NRI even though \autoref{fig:fig:perf-result} lists "No Filter" as the best option.
