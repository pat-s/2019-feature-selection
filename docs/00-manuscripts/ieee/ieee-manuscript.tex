...
In principal any index can be used for this data-driven concept.
Due to the popularity of the NDVI index in vegetation applications and the availability of this index in the \texttt{nri()} function of the \texttt{hsdar} R package, the following formula was applied to every available band combination:
