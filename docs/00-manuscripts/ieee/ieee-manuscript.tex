...
Overall, SVM used the least features across all plots among all learners, with 24\% for test set Oiartzun being the highest single ploot value.
Every learner behaved quite differently for each plot and no overall pattern could be observed.
