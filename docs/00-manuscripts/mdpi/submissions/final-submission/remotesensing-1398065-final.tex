...
\newcommand{\orcidauthorC}{0000-0003-2567-8689} % Add \orcidC{} behind the author's name
\newcommand{\orcidauthorD}{0000-0002-6390-5873} % Add \orcidD{} behind the author's name
\newcommand{\orcidauthorE}{0000-0001-6002-6980} % Add \orcidE{} behind the author's name
\newcommand{\orcidauthorF}{0000-0001-6640-679X} % Add \orcidF{} behind the author's name
...
\address{%
$^{1}$ \quad GIScience Group, Department of Geography, Friedrich Schiller University Jena, Germany;
 malnamalja@gmx.de~(J.M.); jose.cortes@uni-jena.de~(J.C.); alexander.brenning@uni-jena.de~(A.B.)\\
$^{2}$ \quad NEIKER Tecnalia, Spain; eiturritxa@neiker.eus\\
$^{3}$ \quad Department of Statistics, Ludwig-Maximilians-Universität München, Germany; bernd.bischl@stat.uni-muenchen.de
}
...
\dataavailability{The data presented in this study are openly available in Zenodo at \url{https://doi.org/10.5281/zenodo.2635403} (accessed on 27 November 2021).}


\acknowledgments{We acknowledge support by the German Research Foundation and the Open Access Publication Fund of the Thueringer Universitaets- und Landesbibliothek Jena Projekt-Nr. 433052568.}
...
\newblock {\em Hyperspectral Indices and Image Classifications for Agriculture
  and Vegetation}; {CRC Press}:  Boca Raton, FL, USA, 2018, doi:10.1201/9781315159331.
...
\newblock {\em Silva Fenn.} {\bf 1993}, {\em 27}, doi:10.14214/sf.a15668.
...
\newblock {\em Interpretable Machine Learning---{{A Guide}} for {{Making Black
  Box Models Explainable}}}; self-published: Munich, Germany, 2019.
...
\newblock {\em R: A {{Language}} and {{Environment}} for {{Statistical
  Computing}}};  R Core Team: 2019, Vienna, Austria.
...
\newblock {\em J. Open Source Softw.} {\bf 2018}, {\em 3}.
...
\newblock Evaluation of Vegetation Indices and a {{Modified Simple Ratio}} for
  Boreal Applications;
\newblock {\emph{Canadian Journal of Remote Sensing}}:  1996, \emph{22}, 229-242, doi:10.4095/218303.
