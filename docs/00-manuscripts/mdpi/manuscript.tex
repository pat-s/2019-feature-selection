...
\Author{Patrick Schratz $^{1}$\orcidA{}*, Jannes Muenchow $^{1}$\orcidB{}, José Cortés $^{1}$\orcidC{}, Eugenia Iturritxa $^{2}$\orcidD{}, Bernd Bischl $^{3}$\orcidE{} and Alexander Brenning $^{1,}$\orcidF{}}
...
$^{3}$ \quad Ludwig-Maximilians-Universiy Munich, Department of Statistics, Computational Statistics group, Germany
}
...
% now that we introduced the importance of remote sensing indices for forest health, explain what is new in this study
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{Conceptualization, Patrick Schratz and Alexander Brenning; methodology, Patrick Schratz, José Cortés and Jannes Muenchow and Bernd Bischl; software, Patrick Schratz; validation, Patrick Schratz and Alexander Brenning; formal analysis, Patrick Schratz, Alexander Brenning, José Cortés and Bernd Bischl; investigation, Patrick Schratz; resources, Eugenia Iturritxa and Patrick Schratz; data curation, Patrick Schratz and Eugenia Iturritxa; writing---original draft preparation, Patrick Schratz; writing---review and editing, Patrick Schratz and Alexander Brenning; visualization, Patrick Schratz; supervision, Alexander Brenning and Bernd Bischl; project administration, Alexander Brenning; funding acquisition, Alexander Brenning. All authors have read and agreed to the published version of the manuscript.}
...
\begin{table}
	\caption[t]{List of available vegetation indices in the \texttt{hsdar} package.}
