...
devtools::install_github("pat-s/mlr@blocking_visualization")
...
parallelStop()
saveRDS(resa_glmnet, "/data/patrick/mod/hyperspectral/spcv/all_plots_ridge_bf2_10folds.rda")
```
...
parallelStop()
saveRDS(resa_glmnet, "/data/patrick/mod/hyperspectral/spcv/all_plots_lasso_bf2_10folds.rda")
```
...
parallelStop()
saveRDS(resa_glmnet, "/data/patrick/mod/hyperspectral/spcv/all_plots_elasticnet.rda")
```
