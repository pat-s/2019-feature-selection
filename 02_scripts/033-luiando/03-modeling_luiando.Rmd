...
ps_xgboost <- makeParamSet(
  makeIntegerParam("nrounds", lower = 0, upper = 600),
...
```{r}
library(parallelMap)
parallelStart(mode = "multicore", cpus = 40, level = "mlr.resample",
              mc.set.seed = TRUE) # only parallelize the tuning
set.seed(12345)
...
parallelStop()
saveRDS(resa_rf, "/data/patrick/mod/hyperspectral/spcv/luiando_xgboost.rda")
```
